...
const storage = new CloudinaryStorage({
  ...
  params: async (req, file) => {
    ...
    let folder = 'destinations/seasonal';
...
const uploadSeasonalDestination = (req, res, next) => {
  upload(req, res, async (err) => {
    ...
    // Process main seasonal image (single)
    if (files?.['image']) {
...
export default uploadSeasonalDestination
