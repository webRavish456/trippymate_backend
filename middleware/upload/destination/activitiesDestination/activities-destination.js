...
const storage = new CloudinaryStorage({
  ...
  params: async (req, file) => {
    ...
    let folder = 'destinations/adventure';
    
    if (file.fieldname === 'images') {
      folder = 'destinations';
    } else if (file.fieldname === 'attractionImages') {
      folder = 'destinations/adventure-locations';
...
const uploadActivitiesDestination = (req, res, next) => {
  upload(req, res, async (err) => {
    ...
    // Process main adventure image (single)
    if (files?.['image']) {
    ...
    // Process attraction images (Adventure Locations)
...
export default uploadActivitiesDestination
