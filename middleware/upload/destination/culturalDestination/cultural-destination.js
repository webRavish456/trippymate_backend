...
const storage = new CloudinaryStorage({
  ...
  params: async (req, file) => {
    ...
    let folder = 'destinations/cultural';
    
    if (file.fieldname === 'images') {
      folder = 'destinations';
    } else if (file.fieldname === 'attractionImages') {
      folder = 'destinations/heritage-locations';
...
const uploadCulturalDestination = (req, res, next) => {
  upload(req, res, async (err) => {
    ...
    // Process main cultural image (single)
    if (files?.['image']) {
    ...
    // Process attraction images (Heritage Locations)
...
export default uploadCulturalDestination
